...
public class RouterController {
	...
	@RequestMapping(value = {"xmlEnqueue","XMLEnqueue","xmlenqueue"}, method = RequestMethod.POST,
	consumes = MediaType.TEXT_PLAIN_VALUE, produces = MediaType.APPLICATION_XML_VALUE)
	public ResponseEntity enqueueXML(@RequestBody String xmlMessage, 
			@RequestParam(value = "key", required = true) final String authKey,
